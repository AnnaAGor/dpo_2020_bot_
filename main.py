...
def about_doctor(message):
    ...
    if n in Classic_Docs:
        ...
        if index == 0:
            ...
            bot.send_photo(message.chat.id, pict5[randint(0, 8)])
        elif index == 5:
            bot.send_photo(message.chat.id, pict6[randint(0, 6)])
        elif index == 6:
            bot.send_photo(message.chat.id, pict7[randint(0, 4)])
        elif index == 7:
        ...
        if index == 0:
            ...
            bot.send_photo(message.chat.id, pict9[randint(0, 2)])
        elif index == 2:
...
pict6 = ['https://aif-s3.aif.ru/images/015/653/48009b0ab04eacb7fa56ed12bfde0653.jpg',
         ...
         'https://s2.funon.cc/img/orig/201507/28/55b776f706c68.jpg']
pict7 = ['https://www.syl.ru/misc/i/ni/1/1/7/4/6/5/i/117465_700x525.jpg',
         'http://factmag-images.s3.amazonaws.com/wp-content/uploads/2013/11/remembrance-11.21.2013.jpg',
...
pict9 = ['https://wallup.net/wp-content/uploads/2018/10/05/907485-doctor-who-bbc-sci-fi-futuristic-series-comedy-adventure-drama-1dwho-tardis.jpg',
         ...
         'https://ic.pics.livejournal.com/debora_debora/25070693/51899/51899_original.jpg']
